...
export const privacy = () => {
  return (
    <DetailWrapper>
      ...
      <p>
        Brooks Becton built the 7 Wonders Calculator app as an Ad Supported app.
        This SERVICE is provided by Brooks Becton at no cost and is intended for
        use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at 7 Wonders Calculator
      ...
      <p>This policy is effective as of 2021-12-12</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at dirtydogsoftware88@gmail.com.
      </p>
      <p>
