...
export class Migration20201013192058 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "table" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "owner_id" varchar(255) not null);');
    ...
    this.addSql('alter table "player" add constraint "player_table_id_unique" unique ("table_id");');
